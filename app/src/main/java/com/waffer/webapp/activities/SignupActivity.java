...
import com.waffer.webapp.Interface.OnSignupLoginListener;
import com.waffer.webapp.Model.Login.User;
import com.waffer.webapp.Model.RegisterBusiness;
import com.waffer.webapp.Model.RegisterUser;
import com.waffer.webapp.Model.categories.Category;
import com.waffer.webapp.Model.categories.SubCategory;
...
import static com.waffer.webapp.Retrofit.RetrofitUtil.SignupUser;
import static com.waffer.webapp.activities.BookAppointmentDetailActivity.REQUEST_CODE_VERIFICATION;
...
public class SignupActivity extends BaseActivity implements OnSignupLoginListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.btn_register_now);
        ...
        findViewById(R.id.terms_condition).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(SignupActivity.this, PrivacyPolice.class));
            }
        });
