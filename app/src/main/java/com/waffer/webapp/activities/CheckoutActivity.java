...
import com.waffer.webapp.Interface.DialogInteractionListener;
...
import com.waffer.webapp.Model.order_model.OrderDetails;
import com.waffer.webapp.Model.order_model.OrderProducts;
...
import com.waffer.webapp.Model.order_model.PostOrder;
import com.waffer.webapp.Model.order_model.UserBilling;
import com.waffer.webapp.Model.order_model.UserShipping;
import com.waffer.webapp.Model.order_model.coupons_model.CouponDetails;
import com.waffer.webapp.Model.order_model.get_tax.GetTax;
import com.waffer.webapp.Model.order_model.get_tax.Product;
import com.waffer.webapp.Model.packages.PackageItem;
import com.waffer.webapp.R;
import com.waffer.webapp.Retrofit.ProviderApi;
...
import com.waffer.webapp.Utils.ValidateInputs;
import com.waffer.webapp.adapters.PaymentMethodAdapter;
import com.waffer.webapp.fragments.PackagesRecyclerViewAdapter;
...
import static com.waffer.webapp.Retrofit.RetrofitUtil.getUserProfile;
